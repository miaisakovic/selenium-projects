...
try:
    wait.until(ExpectedCondition.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "mathNEWS ")))
...
# The relative path to a folder where the article should be saved (does not need to exist) 
...
# Download the article and save it in the local folder under the specified file name
