...
if driver.current_url == (insta_url + "accounts/login/two_factor?next=%2F"):
    security_code = input("\nEnter your 6-digit code generated by an " +
                          "authentication app:\n")
    try:
...
if driver.current_url == (insta_url + "accounts/onetap/?next=%2F"):
    try:
        wait.until(ExpectedCondition.element_to_be_clickable((
                                                        By.XPATH,
                                                        "//*[text()='Not Now']"
        ...
        assert False, "Can't select the 'Not Now' option when asked \
                       about saving login info"
...
try:
    ...
    # If the popup for notifications is not present,
    #   proceed to view the user's Instagram profile
    pass

driver.get(insta_url + user_username)
...
try:
    ...
    profile_pic = driver.find_element(By.CSS_SELECTOR,
                                      "button[title='Change profile photo']")
    profile_pic.click()
except Exception:
    try:
        ...
        wait.until(ExpectedCondition.element_to_be_clickable((
                                        By.CSS_SELECTOR,
                                        "button[title='Add a profile photo']"
                                      )))
...
if photo:
    try:
        ...
        upload_profile = driver.find_element(By.XPATH,
                                             "//*[text()='Upload Photo']")
